{ lib, pypa, mocks, ... }:
let
  inherit (pypa) normalizePackageName parsePythonTag parseABITag parseWheelFileName isWheelFileName isPythonTagCompatible isABITagCompatible isPlatformTagCompatible isWheelFileCompatible selectWheels isSdistFileName matchWheelFileName matchEggFileName isEggFileName parseEggFileName selectEggs;
